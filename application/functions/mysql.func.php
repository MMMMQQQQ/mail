...
// Create connection
    ...
    $link = mysqli_connect ( $servername, $username, $password,DB_DBNAME ) or die ( '数据库连接失败<br/>ERROR ' . mysqli_connect_errno () . ':' . mysqli_connect_error () );
...
// sql to create table
    $sql = "CREATE TABLE IF NOT EXISTS 51zxw_user (
id INT UNSIGNED AUTO_INCREMENT KEY,
username VARCHAR(20) NOT NULL UNIQUE,
password CHAR(32) NOT NULL,
email VARCHAR(50) NOT NULL,
token CHAR(32) NOT NULL  ,
token_exptime INT UNSIGNED NOT NULL  ,
